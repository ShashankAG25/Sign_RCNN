...
# Removing texts and noises , retains ony Logo ,stamps and signature in SPODS only
def preprocess(img):
...
image = preprocess("sign/img/29.png")
# cv2.namedWindow('Output', cv2.WINDOW_NORMAL)
# cv2.imshow("Output", image)
# cv2.waitKey(0)
df = pd.read_csv("sign/label_csv/29.csv")
# print(df)
gtvalues = []
...
display_regions(image,ssresults)
